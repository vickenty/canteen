...
CREATE TABLE users (email text, password text, created_at date, last_login_at date, last_login_ip text, active bool default 1 not null, mail_digest bool default 0 not null);
